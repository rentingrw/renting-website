      ...
      <section className="flex min-h-[calc(100vh-140px)] flex-col items-center justify-center px-4 py-20 text-center">
        <div className="mx-auto max-w-2xl">
          <div className="mb-8 flex justify-center">
            <div className="flex h-24 w-24 items-center justify-center rounded-md border-2 border-border bg-sky-400 shadow-brutal">
              <BedDouble className="h-12 w-12 text-foreground" />
            </div>
          </div>

          <span className="inline-block rounded border-2 border-amber-500 bg-amber-400 px-4 py-1 text-xs font-black uppercase tracking-widest text-foreground">
            Coming Soon
          </span>
          ...
          {/* Countdown timer */}
          <div className="mt-12">
            <div className="mb-4 flex items-center justify-center gap-2 text-sm font-bold text-muted-foreground">
            ...
            <div className="flex items-start justify-center gap-4">
              {[
                ...
                <div key={label} className="flex flex-col items-center">
                  ...
                  <span className="mt-2 text-xs font-black uppercase tracking-widest text-muted-foreground">{label}</span>
                </div>
              ))}
            </div>
          </div>

          <div className="mt-12 rounded-2xl border border-border bg-card p-6 shadow-card text-left">
            <h2 className="text-lg font-black text-foreground">What to expect</h2>
            <ul className="mt-4 space-y-3 text-sm font-medium text-muted-foreground">
              {[
                ...
                <li key={item} className="flex items-start gap-2">
                  <span className="mt-0.5 h-5 w-5 shrink-0 rounded-full border-2 border-brand bg-brand-soft flex items-center justify-center text-xs font-black text-brand">✓</span>
                  {item}
                </li>
              ))}
            </ul>
