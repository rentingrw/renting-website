  ...
  return (
    <main className="flex min-h-screen flex-col bg-background">
      ...
      <section className="mx-auto max-w-5xl px-4 py-16 sm:px-6">
        <h2 className="mb-10 text-center text-2xl font-black text-foreground">What We Offer</h2>
      ...
      <section className="border-t-2 border-b-2 border-border bg-card px-4 py-14 sm:px-6">
        <div className="mx-auto max-w-3xl text-center">
          <h2 className="mb-6 text-2xl font-black text-foreground">Who We Serve</h2>
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
            {[
              ...
              <div key={c} className="rounded-md border-2 border-border bg-card px-4 py-3 text-sm font-black text-foreground shadow-brutal-xs">
                {c}
              </div>
            ))}
          </div>
      ...
      <section className="mx-auto max-w-3xl px-4 py-16 text-center sm:px-6">
        <h2 className="mb-3 text-2xl font-black text-foreground">Get a Corporate Quote</h2>
        ...
        <div className="flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
          <a
            ...
            className="flex items-center gap-2 rounded border-2 border-brand-strong bg-brand px-7 py-3 font-black uppercase tracking-wide text-white shadow-brutal-sky-sm transition-all hover:translate-x-px hover:translate-y-px hover:shadow-none"
          >
            <Phone className="h-4 w-4" /> 0788 781 648
          </a>
          <a
            href="mailto:renting.rw@gmail.com"
            className="flex items-center gap-2 rounded border-2 border-border bg-card px-7 py-3 font-black uppercase tracking-wide text-foreground shadow-brutal-xs transition-all hover:translate-x-px hover:translate-y-px hover:shadow-none"
          >
