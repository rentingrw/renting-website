      ...
      <section className="mx-auto max-w-3xl px-4 py-14 sm:px-6">
        <div className="space-y-8 text-sm text-gray-600 leading-relaxed">
          <p>
            ...
            by <strong>CARIRWA LTD</strong> (&quot;Company&quot;, &quot;we&quot;, &quot;us&quot;). By creating an account or
            using our services, you agree to these Terms.
          </p>

          <div>
            <h2 className="mb-2 text-lg font-bold text-gray-900">1. The Platform</h2>
            <p>
          ...
          <div>
            <h2 className="mb-2 text-lg font-bold text-gray-900">2. Eligibility</h2>
          ...
          <div>
            <h2 className="mb-2 text-lg font-bold text-gray-900">3. Bookings</h2>
            <p>
          ...
          <div>
            <h2 className="mb-2 text-lg font-bold text-gray-900">4. Host Obligations</h2>
            <ul className="list-disc list-inside space-y-1">
          ...
          <div>
            <h2 className="mb-2 text-lg font-bold text-gray-900">5. Guest Obligations</h2>
            <ul className="list-disc list-inside space-y-1">
          ...
          <div>
            <h2 className="mb-2 text-lg font-bold text-gray-900">6. Payments and Fees</h2>
            <p>
          ...
          <div>
            <h2 className="mb-2 text-lg font-bold text-gray-900">7. Prohibited Conduct</h2>
          ...
          <div>
            <h2 className="mb-2 text-lg font-bold text-gray-900">8. Limitation of Liability</h2>
            <p>
          ...
          <div>
            <h2 className="mb-2 text-lg font-bold text-gray-900">9. Account Termination</h2>
            <p>
          ...
          <div>
            <h2 className="mb-2 text-lg font-bold text-gray-900">10. Governing Law</h2>
            <p>
          ...
          <div>
            <h2 className="mb-2 text-lg font-bold text-gray-900">11. Contact</h2>
            <p>
