...
-- CreateEnum
CREATE TYPE "BookingStatus" AS ENUM ('pending', 'confirmed', 'auto_cancelled', 'overlap_declined', 'cancelled_by_renter', 'cancelled_by_owner', 'cancelled_admin', 'active', 'auto_completed', 'disputed');
